    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <main className="container mx-auto px-4 pt-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">클라이밍 중고거래</h1>
            <p className="text-gray-600">믿을 수 있는 클라이머들과 안전하게 거래하세요</p>
          </div>
          {user && (
        ...
        {!user && (
          <div className="text-center mt-8 p-6 bg-white rounded-lg shadow">
            <p className="text-gray-600 mb-4">상품을 등록하려면 로그인이 필요합니다.</p>
            <Link to="/login">
              <Button>로그인하기</Button>
            </Link>
          </div>
